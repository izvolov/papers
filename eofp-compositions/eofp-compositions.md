...
![Простое отображение](simple-composition.png)
...
![Результат](nary-composition.png)

То есть компоновать с функцией `std::less` мы должны весь этот блок:
![Как компоновать](how-to-compose.png)
